...
void limited(){
  ...
  files[0] = TFile::Open("DeepCSV_proper_skim2_ttBar.root");   
  files[1] = TFile::Open("ROCFull.root");
  //files[2] = TFile::Open("DeepCSV_gradient_skim_TTBar.root");
 // files[3] = TFile::Open("DeepCSV_random_skim_TTBar.root");
  ...
  legend->AddEntry(graphlvsb[0],"LRP pruned","f");
  legend->AddEntry(graphlvsb[1],"Full","f");
  //legend->AddEntry(graphlvsb[2],"Gradient Pruned","f");
 // legend->AddEntry(graphlvsb[3],"Random Pruned","f");
