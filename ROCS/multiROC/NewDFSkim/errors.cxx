...
void errors(){
  const char *dirname="/home/emil/NNStudies/ROCS/multiROC/NewDFSkim";
  const char *ext=".root";
  TFile *filearray[4] = {};
  TSystemDirectory dir(dirname, dirname);
  TList *files = dir.GetListOfFiles();
  TFile * letsgo = TFile::Open("/home/emil/NNStudies/10XTrainingStudies/10XTrainingsPlot/DFRNN_lrpSkimV2_cuttracks_v2_ttbarhad_30.root ");
  ...
  //  one->Draw("same");
  // two->Draw("same");
  //one->SetLineColor(kYellow);
  //two->SetLineColor(kYellow);
