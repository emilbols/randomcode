...
void script(){
  ...
  TFile *hfile13 = TFile::Open("/home/emil/NNStudies/ROCS/multiROC/ReadDir/LOLDIR/DeepCSV_skim_ttBar.root");  
 ...
 // ge1->SetTitle("DeepCSV spread due to initialization");
  ...
  legend2->AddEntry(ab1,"Full data uds","l");
  legend2->AddEntry(ab2,"Full data c","l");
